...
header = {
    'User-Agent': 'curl/7.30.0',
     'Accept': 'application/json',                                                  'user-key': 'b7d9287f5bdd31409214ac5a6bde1482',
}
zomato_rs = requests.get(url=zomato_url,proxies={'https': "https://rit2015034:iiita034@172.31.1.6:8080"},headers=header,params=param).json()
...
zomato_ans = requests.get(url = zomato_url2,headers=header,proxies={'https': "https://rit2015034:iiita034@172.31.1.6:8080"}).json()
